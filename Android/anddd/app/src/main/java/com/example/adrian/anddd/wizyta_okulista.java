...
public class wizyta_okulista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wizyta_okulista);

        setTitle("Wybierz Date i godzinę wizyty:");
        Rezygnuj = findViewById(R.id.sebRezygnuj);
        ZmienSp = findViewById(R.id.sebZmienSpec);
        UmowWizyte = findViewById(R.id.sebUmowWizyte);
        specSpin = findViewById(R.id.sepinerSpec);
        lekSpin = findViewById(R.id.sepinerLek);
        EndowyTekst = findViewById(R.id.seKoncoweTextView);
