...
public class wizyta_rodzinny extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wizyta_rodzinny);

        setTitle("Wybierz Date i godzinę wizyty:");
        Rezygnuj = findViewById(R.id.srbRezygnuj);
        ZmienSp = findViewById(R.id.srbZmienSpec);
        UmowWizyte = findViewById(R.id.srbUmowWizyte);
        specSpin = findViewById(R.id.srpinerSpec);
        lekSpin = findViewById(R.id.srpinerLek);
        EndowyTekst = findViewById(R.id.srKoncoweTextView);
       // final String name = (String) getIntent().getStringExtra("WybSpecjalizacjja");
        ...
        try {
            ...
            final String queray = "SELECT Imie, Nazwisko FROM `lekarze` WHERE Specjalizacja='Rodzinny'";
